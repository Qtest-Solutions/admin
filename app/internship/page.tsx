...
export default function InternshipPage() {
  ...
  const learningTopics = [
    ...
    },
    {
      ...
      description: 'Experience agile methodologies, sprints, and collaborative team environments.',
      color: 'teal',
    },
    {
      icon: GitBranch,
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: 'We offer internships in Software Testing & QA, Software Development, UI/UX Design, and Digital Marketing. Each track has its own curriculum and learning path tailored to industry requirements.',
    },
    {
    ...
    },
    {
      ...
      answer: 'The tools depend on your chosen domain. You will get hands-on experience with industry-standard tools like Jira, Git, Figma, various development frameworks, marketing tools, and more based on your track.',
    },
    {
  ...
  const targetAudience = [
    { icon: GraduationCap, title: 'Students', description: 'Final year or pre-final year students looking for practical experience', color: 'teal' },
    { icon: Award, title: 'Fresh Graduates', description: 'Recent graduates wanting to kickstart their career', color: 'cyan' },
    { icon: TrendingUp, title: 'Career Switchers', description: 'Professionals from other fields interested in a new domain', color: 'emerald' },
  ];
        ...
        <div className="container mx-auto px-6">
          <div className={`max-w-5xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-10 max-w-3xl mx-auto leading-relaxed">
              Gain hands-on experience in Software Testing, Development, UI/UX Design, or Digital Marketing through structured mentorship and real projects.
            </p>
