    ...
    >
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 flex items-center justify-center space-x-4 mt-20">
            {/* <div
              className="flex items-center space-x-2 backdrop-blur-sm border rounded-full px-4 py-2"
              style={{
