...
const AnimatedBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0">
        {Array.from({ length: 50 }).map((_, i) => (
          <div
            ...
            style={{ backgroundColor: 'rgba(80, 188, 183, 0.3)' }}
            style={{
      ...
      {/* Geometric Patterns */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full blur-3xl animate-pulse" style={{ background: `linear-gradient(to right, rgba(80, 188, 183, 0.1), transparent)` }}></div>
