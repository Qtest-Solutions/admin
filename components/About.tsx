...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-16 relative bg-gradient-lavender"
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-16 left-16 w-96 h-96 bg-brand-sage-200/15 rounded-full blur-3xl animate-gentle-float" style={{ animationDelay: '3s' }} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6 items-start mb-12">
            ...
            <div className="space-y-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              {/* Mission Card */}
              <div className="glass-professional p-6 rounded-2xl shadow-professional h-auto">
                ...
                <p className="text-sm text-brand-neutral-600 leading-relaxed font-medium">
                  We are <span className="text-brand-sage-600 font-semibold">pioneers in quality assurance</span> and testing solutions,
                  combining cutting-edge technology with deep industry expertise to deliver exceptional results that transform businesses.
                </p>
              </div>
              ...
              <div className="glass-professional p-6 rounded-2xl shadow-professional h-auto">
                ...
                <p className="text-sm text-brand-neutral-600 leading-relaxed font-medium">
                  Our team consists of <span className="text-brand-lavender-600 font-semibold">seasoned professionals</span> with years of
                  experience in software testing, quality assurance, and training. We bring industry best practices to every project.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="glass-professional p-6 rounded-2xl shadow-professional h-auto">
                ...
                <p className="text-sm text-brand-neutral-600 leading-relaxed font-medium">
                  We understand the <span className="text-brand-coral-600 font-semibold">unique challenges</span> faced by
                  startups and career aspirations of students, allowing us to provide tailored solutions that drive sustainable success.
                </p>
              </div>
              ...
              <div className="glass-professional p-6 rounded-2xl shadow-professional h-auto">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 rounded-xl bg-brand-sage-50/50 border border-brand-sage-100/50">
                    ...
                    <span className="text-sm font-semibold text-brand-sage-700">Excellence</span>
                    <p className="text-xs text-brand-sage-600 mt-1">Quality First</p>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-brand-lavender-50/50 border border-brand-lavender-100/50">
                    ...
                    <span className="text-sm font-semibold text-brand-lavender-700">Innovation</span>
                    <p className="text-xs text-brand-lavender-600 mt-1">Future Ready</p>
                  </div>
                </div>
              </div>
            </div>
